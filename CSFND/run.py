...
def run():
    ...
    print("the ab hyperparameters UNSPR:{}_MultiCLS:{}_AGG:{}_AVG:{}".format(args.unspr,args.multicls,args.agg,args.avg))
    ...
    final_saved_model_path = './FinalModel_{}_clu{}_lClu{}_lTri{}_UNSPR{}_MultiCLS{}_AGG{}_AVG{}.pt'.format(
        args.dataset, args.n_clusters, args.lambda_cluster, args.lambda_triplet_class,args.unspr,args.multicls,args.agg,args.avg)
    ...
    fake_res, real_res = multi_classifiers(args,
    ...
    f.write('{:<8}_CLU{:<2d}_lambdaClu{:<.2f}_lambdaTri{:<.2f}_UNSPR{}_MultiCLS{}_AGG{}_AVG{}_{:<8}|'.format(
        args.dataset, args.n_clusters, args.lambda_cluster, args.lambda_triplet_class,args.unspr,args.multicls,args.agg,args.avg, 'mlp'))
